...
Session commit range: `7985174` (v0.1.0) … `f445980` (v0.14.1), plus this report.
...
- The predecessor implementation (commit `9c77f94`, before the rewrite) recorded 78× per-step
...
pytest` — 96 pass at `f445980`.

### 8.2 Result → job → commit map

"Commit" = the commit whose tree contains the result JSON (added there; `git log
--diff-filter=A`). Code state for the §4.1 sweep runs was `334e09b`–`7dff2c2` as recorded in
the run log of `experiments/exp1_language_modeling/EXPERIMENT_STATUS.md`.

| result (JSON tag) | job | HW | commit |
|---|---|---|---|
| pilot_mfvi_T3 / pilot_exact_T3 | 940422 / 940423 | TITAN | 334e09b / 0a31441 |
| probe_T1 / probe_l2_5 / probe_lambdaZ4 | 940436 / 940435 / 940438 | TITAN/TITAN/A40 | 0a31441 |
| sweep_lz16/32/64 | 940483/84/85 | TITAN/TITAN/A40 | 7dff2c2 |
| step1_nob / step1_withb | 940444 / 940445 | TITAN | e43dd40 |
| init0.2 / init0.5 | 940489 / 940490 | TITAN | 7dff2c2 |
| tau1 / tau4 / tau8 | 940502/503/504 | TITAN/TITAN/A40 | 4668d0e |
| base_gpt / base_looped / base_pt / scale_bisection | 940799 | A40 | 7d95b95 |
| lr_probe | 940809 | TITAN | a6921e0 |
| region_probe (grid, replicate, PTB) | 940814 | A40 | 71c926c |
| deconfound_dh | 940827 | A40 | fead1a0 |
| attack (3a/3b) | 940844 | A40 | 93a26a2 |
| attack_freezeb / attack_long | 940848 / 940850 | A40 | a7697e0 |
| attack_final (ladder 16/24/32) | 940858 | A40 | 9c73992 |
| G_R1 / G_R2 | 940872 / 940879 | A40 | 6d50f53 |
| damp_d32_a0.5 / a0.25 / d48 / d64 | 940913/914/915/916 | TITAN | 6efa62a |
| G_rev_d24 | 940918 | TITAN | e97e924 |
| combo_d32 / full_d32 / floor_d32 | 940920 / 940921 / 940927 | TITAN | e97e924 |
...
- **Generator-bug boundary (`8b7d1b1`, v0.8.2).** `Dirichlet.sample` ignores its generator
...
- **Trace-minimum boundary.** JSONs written before `9c73992` carry `val_ppl` = min over the
  trace; from `9c73992` on, `val_ppl` = final and `val_ppl_min` is kept alongside. The only
...
Checks 1–9 of the research plan pass (96 behavioural tests at `f445980`); the worked example
